				...
				{?>
                  <tr >
					...
					<?php echo $row['da'];?>
                      ...
                      <td>
                        <a href="quote-details.php?id=<?php echo $row['id'];?>"><button class="btn-danger-dark">View</button></a>
                        <form method="post" style="display:inline;margin-left:6px;" onsubmit="return confirm('Delete this quote?');">
                          <input type="hidden" name="id" value="<?php echo $row['id'];?>" />
                          <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token'];?>" />
                          <button type="submit" name="delete_quote" class="btn btn-danger btn-xs">Delete</button>
                        </form>
                      </td>
                  </tr>
                 <?php $cnt=$cnt+1; } ?>
