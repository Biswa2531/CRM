...
if($num>0)
{
$extra = !empty($_SESSION['admin_redirect_url']) ? $_SESSION['admin_redirect_url'] : 'home.php';
unset($_SESSION['admin_redirect_url']);
if (strpos($extra, '://') !== false || strpos($extra, '//') === 0 || preg_match('/index\.php|logout\.php/i', $extra)) {
    $extra = 'home.php';
}
...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign in to ResolveHub Admin</h2>
